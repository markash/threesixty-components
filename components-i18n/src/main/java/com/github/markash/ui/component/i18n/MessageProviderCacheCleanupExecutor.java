 ...
 */
package com.github.markash.ui.component.i18n;
...
public class MessageProviderCacheCleanupExecutor {
     ...
     */
    public static final String ENV_PROP_MESSAGE_PROVIDER_CACHE_CLEANUP_INTERVAL_SECONDS = "threesixty.i18n.message-provider-cache.cleanup-interval-seconds";
    ...
    public MessageProviderCacheCleanupExecutor(final Environment environment,
        ...
        if (cleanupInterval > 0) {
            if (compositeMessageSource.isMessageFormatCacheEnabled()) {
                ...
                cleanupJob = executorService.scheduleAtFixedRate(() -> {
