...
/**
 * This is a class that describes a side bar section that has been declared using a {@link MenuSection} annotation.
 *
...
public class MenuSectionDescriptor implements Comparable<MenuSectionDescriptor> {
     ...
     * @param i18n    the {@link I18N} instance to use when looking up localized captions, must not be {@code null}.
     */
    public MenuSectionDescriptor(
    ...
    /**
     * Returns the caption of this side bar section. If the caption was specified using {@link MenuSection#captionCode()},
